...
def main():
    ...
    display_success_rate("environments/random_env/data/push_data_kgraph")
    display_push_action_para("environments/random_env/data/push_data_kgraph")    # drive task random plots
