...
from robot_brain.global_variables import DT, PROJECT_PATH, DATA_PATH, LOG_METRICS, SAVE_LOG_METRICS
...
def main():
    ...
    save_path = create_new_directory(dir_path="environments/push_point_env/data/")
