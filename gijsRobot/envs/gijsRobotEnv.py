...
from gijsRobot.resources.gijsRobot import GijsRobot
from gijsRobot.resources.plane import Plane
from gym_envs_urdf.urdfCommon.urdfEnv import UrdfEnv


class GijsRobotEnv(UrdfEnv):
    metadata = {"render.modes": ["human"]}

    def __init__(self, render=False, dt=0.01):
        super().__init__(GijsRobot(), render=render, dt=dt)
        self.setSpaces()
